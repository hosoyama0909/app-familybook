...
| QTC-MEMO-01 | 記録のメモをあとから編集 | memoが更新・保持 | SWR-LOG-10 | ✅ Pass |
| QTC-WHO-01 | だれの記録か（長女）を付けて記録 | childId反映・物語プロンプトに名前 | SWR-LOG-11,12 | ✅ Pass |
| QTC-WHO-02 | 未指定（なし）に戻す | childId='' に戻せる | SWR-LOG-11 | ✅ Pass |
